...
if($classAsset = ArrayHelper::getValue($params, '_admin.layout.assetClass', false)){
    $classAsset::register($this);
}


$cssText = <<<CSS
    .supervisor-index #supervisor .box{height:auto;}
CSS;
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><i class="fa fa-paw"></i> <span><?=ArrayHelper::getValue($params, 'siteName', 'SiteName')?></span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        ...
                        \yiister\gentelella\widgets\Menu::widget(
                            [
                                "items" => (new MenuDynamic)->generate()
                            ]
                        )
                        ?>
                    </div>
